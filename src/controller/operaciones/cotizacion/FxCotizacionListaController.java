...
public class FxCotizacionListaController implements Initializable {
    ...
    public void initLoad() {
        ...
        if (!lblLoad.isVisible()) {
            paginacion = 1;
            fillTableCotizacion((short) 1, "", Tools.getDatePicker(txtFechaInicio), Tools.getDatePicker(txtFechaFinal));
            opcion = 0;
        }
    }
    ...
    private void onEventPaginacion() {
        switch (opcion) {
            case 0:
                ...
                break;
            case 1:
                fillTableCotizacion((short) 2, txtBuscar.getText().trim(), "", "");
                break;
            case 2:
                fillTableCotizacion((short) 3, "", Tools.getDatePicker(txtFechaInicio), Tools.getDatePicker(txtFechaFinal));
                break;
        }
    }
