...
public class FxNotaCreditoRealizadasController implements Initializable {
    ...
    public void initLoad() {
        if (!lblLoad.isVisible()) {
            paginacion = 1;
            fillNotaCreditoTable(0, "", Tools.getDatePicker(txtFechaInicio), Tools.getDatePicker(txtFechaFinal), paginacion);
            opcion = 0;
        }
    }

    private void fillNotaCreditoTable(int opcion, String buscar, String fechaInico, String fechaFinal, int posicionPagina) {
    ...
    private void onEventPaginacion() {
        switch (opcion) {
            case 0:
                ...
                break;
            case 1:
                fillNotaCreditoTable(1, txtSearch.getText().trim(), "", "", paginacion);
                break;
        }
    }
