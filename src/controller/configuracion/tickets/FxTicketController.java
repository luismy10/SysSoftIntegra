        ...
        if (idTicket != 0) {
            ...
            if (value == 1) {
                ...
                if (result.equalsIgnoreCase("deleted")) {
                    ...
                    Tools.AlertMessageConfirmation(vbWindow, "Ticket", "El ticket es predeterminado, no puede eliminar por el momento.");
                } else {
                    Tools.AlertMessageConfirmation(vbWindow, "Ticket", result);
                }
