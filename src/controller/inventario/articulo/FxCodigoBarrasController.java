    ...
    private void cargarCodigo() {
        if (articuloProcesoController != null) {
            if (codigo != null && (cbCodificacion.getSelectionModel().getSelectedIndex() == 0 || cbCodificacion.getSelectionModel().getSelectedIndex() == 1)) {
                ...
                Tools.AlertMessage(window.getScene().getWindow(), Alert.AlertType.WARNING, "Artículo", "No genero el codigo de barras o no selecciono un tipo de codigo de barras.", false);
            }
